...
def patents(request):
    return render(request,'academic/patents.html',{'main_menu':"学术研究",'sub_menus':sub_menus,'position':"patents"})
...
def theses(request):
    return render(request,'academic/theses.html',{'main_menu':"学术研究",'sub_menus':sub_menus,'position':"theses"})
